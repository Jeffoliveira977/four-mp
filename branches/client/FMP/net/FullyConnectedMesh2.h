...
public:
	...
	void GetParticipantCount(DataStructures::DefaultIndexType *guidRequestListSize, DataStructures::DefaultIndexType *participantListSize) const;
	/// \internal
...
protected:
	...
	DataStructures::Multilist<ML_UNORDERED_LIST,RakNetGUID> guidRequestRetryList;
